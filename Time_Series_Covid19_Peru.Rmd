...
Now let's graph!
We use the `dygraph` library to graph an interactive time series of *confirmed*, *recovered* and *deaths* daily cases. Each plot will have 2 variables: the daily number of cases and 7-day moving average.
